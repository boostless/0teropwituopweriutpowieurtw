...
function SetPlayerDisp(){
    ...
    fetch("http://89.40.2.59:30121/dynamic.json")
        ...
        .catch(console.error ,bot.user.setActivity(`Serveris išjungtas`, {type: "PLAYING"}))
}
...
bot.on("message", async message => {
  ...
  const randomMsg = ['Žie ateik į pm', 'Gandriukas', 'Nu ko nori', 'Easter Egg :)', 'Nebetagink manęs', 'Luktelk dabar esu pas nykštukus']
